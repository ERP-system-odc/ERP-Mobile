...
//import 'package:main_erp_system/screen/Stock/updatestock.dart';
...
Future<Products> fetchProducts() async {
  ...
  if (response.statusCode == 200) {
    ...
    //         sharedPreferences.setString("ids", id);
    print(response.body);
                          ...
                          children: [
                            Padding(
                              ...
                              child: ListTile(
                                  ...
                                  subtitle: Text(
                                      "Stock Cost ${snapshot.data!.foundProduct[index].productInventoryCost.toString()}"),
                                  trailing: IconButton(
                                      onPressed: () {
                                        // Navigator.push(
                                        //     context,
